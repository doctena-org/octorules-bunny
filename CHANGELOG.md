...
### Fixed
- BN100 on access-list rules now validates against the access-list
  action enum (allow, block, challenge, log, bypass) instead of the
  WAF custom-rule action enum. WAF custom rules unchanged.
